...
public static final class SwerveConstants {
  public static final double TRACKWIDITH_METERS = Units.inchesToMeters(15.5);
  ...
  public static final double MAX_ANGULAR_VELOCITY_RAIDIANS_PER_SECOND = MAX_VELOCITY_METERS_PER_SECOND / Math.hypot(TRACKWIDITH_METERS / 2.0, WHEELBASE_METERS / 2.0);

  public static final SwerveDriveKinematics KINEMATICS = new SwerveDriveKinematics(
    new Translation2d(SwerveConstants.TRACKWIDITH_METERS / 2.0, SwerveConstants.WHEELBASE_METERS / 2.0), // Front Left
    new Translation2d(SwerveConstants.TRACKWIDITH_METERS / 2.0, SwerveConstants.WHEELBASE_METERS / 2.0), // Front Right
    new Translation2d(SwerveConstants.TRACKWIDITH_METERS / 2.0, SwerveConstants.WHEELBASE_METERS / 2.0), // Back Left
    new Translation2d(SwerveConstants.TRACKWIDITH_METERS / 2.0, SwerveConstants.WHEELBASE_METERS / 2.0)); // Back Right
  ...
  public static final int BACK_RIGHT_DRIVE_MOTOR = 14; // Back right module motor ID
  public static final int BACK_RIGHT_STEER_MOTOR = 15; // Back right module steer motor ID
  public static final int BACK_RIGHT_STEER_ENCODER = 16; // Back right steer encoder ID
